...
import { type GalleryData, loadGallery, NullGalleryData } from '@data/galleryData.ts';
import { createGalleryCollection, createGalleryImage } from '@data/galleryEntityFactory.ts';
...
program.arguments('<path to images directory>');
program.parse();
